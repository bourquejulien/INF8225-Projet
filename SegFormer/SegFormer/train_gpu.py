...
def get_argparser():
    ...
    parser.add_argument("--dataset", type=str, default='voc2012',choices=['voc2012'], help='Name of dataset')
    ...
    parser.add_argument("--batch_size", type=int, default=6,help='batch size (default: 6)') # consume approximately 3G GPU-Memory
